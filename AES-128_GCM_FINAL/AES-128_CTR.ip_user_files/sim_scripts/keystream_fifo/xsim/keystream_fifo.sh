...
#
# Script generated by Vivado on Thu Nov 20 21:30:22 +0900 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : keystream_fifo.sh
...
#
# Usage        : keystream_fifo.sh
#                keystream_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                keystream_fifo.sh [-reset_run]
#                keystream_fifo.sh [-reset_log]
#                keystream_fifo.sh [-help]
#
...
# script info
echo -e "keystream_fifo.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./keystream_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_13 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot keystream_fifo xil_defaultlib.keystream_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim keystream_fifo -key {Behavioral:sim_1:Functional:keystream_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb keystream_fifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./keystream_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: keystream_fifo.sh [-help]\n\
Usage: keystream_fifo.sh [-step]\n\
Usage: keystream_fifo.sh [-lib_map_path]\n\
Usage: keystream_fifo.sh [-reset_run]\n\
Usage: keystream_fifo.sh [-reset_log]\n\
Usage: keystream_fifo.sh [-keep_index]\n\
Usage: keystream_fifo.sh [-noclean_files]\n\n\
