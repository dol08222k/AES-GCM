...
HD_PWD='C:/Users/user/Desktop/AES-128_CTR/AES-128_CTR.runs/keystream_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log keystream_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source keystream_fifo.tcl
